...
<body>
    ...
    <footer style="padding-top: 45px; align-items: center; background-color: black; color: white; height: 100px;">
        <small>
            <center>
                Copyright &copy; Ease 2019 | Tous droits réservés
            </center>
        </small>
    </footer>
</body>
